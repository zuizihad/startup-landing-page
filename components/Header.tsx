        ...
        <header>
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <Link href={`www.facebook.com`} className="flex items-center">
                        <Logo />
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Handy</span>
                    </Link>
                    <div className="hidden sm:flex items-center xl:order-2">
                        ...
                        <Link href="#" className="text-gray-800 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Get started</Link>
                    ...
                    <div className="flex justify-between items-center sm:hidden sm:w-auto sm:order-1" id="mobile-menu-2">
                        <ul className="flex flex-row sm:flex-col sm:mt-4 font-medium sm:space-x-8 ">
                            <li>
